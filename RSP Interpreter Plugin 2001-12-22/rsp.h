...
#define DllName  "HLE Legacy Plugin 1.4"
#define AboutMsg "High level emulation Plugin 1.4\nMade for Project64 Legacy (c)\nBuild 1\n\nby PJ64LegacyTeam"
#endif
#if ( (defined(DLIST) & !defined(ALIST)) )
#define DllName  "MLE Legacy Plugin 1.4"
#define AboutMsg "Middle level emulation Plugin 1.4\nMade for Project64 Legacy (c)\ninterpreter\n\nby Pj64LegacyTeam"
#endif
#if ( (!defined(DLIST) & defined(ALIST)) )
#define DllName  "GLE Legacy Plugin 1.4"
#define AboutMsg "Graphics Low level emulation Plugin\nMade for Project64 Legacy (c)\ninterpreter\n\nby Pj64LegacyTeam"
#endif
#if ( (!defined(DLIST) & !defined(ALIST)) )
#define DllName  "LLE Legacy Plugin 1.4"
#define AboutMsg "Low Level emulation Plugin 1.4\nMade for Project64 Legacy (c)\ninterpreter\n\nby Pj64LegacyTeam"
#endif
