...
__declspec(dllexport) void GetDllInfo ( PLUGIN_INFO * PluginInfo ) {
	...
	sprintf(PluginInfo->Name,"HLE Legacy Plugin 1.4");
#endif
#if ( (defined(DLIST) & !defined(ALIST)) )
	sprintf(PluginInfo->Name,"MLE Legacy Plugin 1.4");
#endif
#if ( (!defined(DLIST) & defined(ALIST)) )
	sprintf(PluginInfo->Name,"GLE Legacy Plugin 1.4");
#endif
#if ( (!defined(DLIST) & !defined(ALIST)) )
	sprintf(PluginInfo->Name,"LLE Legacy Plugin 1.4");
#endif
